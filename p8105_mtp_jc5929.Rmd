...
```
Plot on the left shows that Raisin has much higher weight than Gagne and Simon. We can also observe that there exits an outlier for Raisin that has a weight of less than 10 pounds. 
